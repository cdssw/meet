...
, ('신속이 생명인데', '신속이 생명인데', 1, 0, 50000, 0, '강남구 역삼동', '1', '서울특별시', '서울특별시 강남구', false, null, null, false, '10:00', '16:00', 40, 2, false, now(), now())
, ('검찰, 모뉴엘 전 대표', '검찰, 모뉴엘 전 대표', 1, 0, 50000, 0, '강남구 역삼동', '2', '서울특별시', '서울특별시 강남구', false, null, null, false, '10:00', '16:00', 40, 1, false, now(), now())
, ('기재차관 국가채무 증가', '기재차관 국가채무 증가', 1, 0, 50000, 0, '강남구 역삼동', '3', '서울특별시', '서울특별시 강남구', false, null, null, false, '10:00', '16:00', 40, 2, false, now(), now())
, ('우리나라 최초 한글점자', '우리나라 최초 한글점자', 1, 0, 50000, 0, '송파구 문정동', '1', '서울특별시', '서울특별시 송파구', false, null, null, false, '10:00', '16:00', 40, 1, false, now(), now())
, ('미 해리스 8월 해군기지', '미 해리스 8월 해군기지', 1, 0, 50000, 0, '송파구 방이동', '1', '서울특별시', '서울특별시 송파구', false, null, null, false, '10:00', '16:00', 40, 2, false, now(), now())
, ('분실 휴대폰서', '분실 휴대폰서', 1, 0, 50000, 0, '송파구 거여동', '1', '서울특별시', '서울특별시 송파구', false, null, null, false, '10:00', '16:00', 40, 2, false, now(), now())
...
, ('온라인 의약품 불법 유통 신고', '온라인 의약품 불법 유통 신고', 2, 0, 50000, 0, '서초구 서초동', '사임동로8길 33', '서울특별시', '서울특별시 서초구', false, null, null, false, '10:00', '16:00', 40, 2, false, now(), now())
, ('아이 등원 요청', '아이를 등원시켜 주실분 구합니다.', 2, 0, 50000, 0, '서초구 서초동', '서운로 62', '서울특별시', '서울특별시 서초구', false, null, null, false, '10:00', '16:00', 40, 2, false, now(), now())
;
